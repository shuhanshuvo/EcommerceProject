...
<section id="do_action">
	<div class="container">
		...
		<div class="paymentCont col-sm-8">
					...
					{{csrf_field()}}
					<input type="radio" name="payment_method" value="handcash">Hand Cash </input><br>
					<input type="radio" name="payment_method" value="bkash">B-kash </input><br>
					<input type="radio" name="payment_method" value="rocket">Rocket </input><br>
