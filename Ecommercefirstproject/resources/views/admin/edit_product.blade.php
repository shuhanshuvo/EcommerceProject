			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/update-product',$product_info->products_id)}}" method="post" enctype="multipart/form-data">
						...
						<div class="control-group">
						  ...
						  <?php 
						  	$all_product_info=DB::table('tbl_products')
						         ...
						         ->select('tbl_products.*','tbl_brands.brands_name')
						    	->first();
						  ?>
						  <div class="control-group">
								<label class="control-label" for="selectError3">Brands Category</label>
								<div class="controls">
								  <select id="selectError3" name="brands_id" value="">
								  <option value = "{{$all_product_info->brands_id}}">{{$all_product_info->brands_name}}</option>
								   <?php
